    ...
    <body class="dialog">
        <div class="container" id="container">
                                                ...
                                                <blockquote class="notop">
                                                    <blockquote class="notop fw urlcontent">
                                                        ...
                                                        <span class="header">
                                                            ...
                                                            <c:set var="commentURL" value="/Dexter/actions/checkurl.do?urlid=" />
                                                            <a href="${commentURL}${resultbean.ID}"><b>Comment</b></a> |
                                                            <span class="multiwordlinks error">${resultbean.category}</span> |
                                                            <a class="favoritedialoginvoker" href="">
                                                                <img height="18" weight="18" src="/Dexter/_images/favorite.png" alt="Favorite!">
            ...
            <div class="footer" id="footer">
                ...
                <div id="favoritedialog" class="hidden" title="Add as Favorite">
                    <p>Choose Tags to Favorite with...</p>
                    <form id="favoritedialogform" action="/Dexter/actions/favorite.do?returnurl=" method="POST">
                        <fieldset>
                            <ul class="nostyle nobullet">
                                <li><div class="fleft"><b>Tags:</b></div>
                                    <div class="fright"><input type="text" class="input" name="tags" value=""></input></div>
                                </li>
                            </ul>
                            <input type="hidden" value="" name="ID" id="favoritebeanID"></input>
