				...
				<div class="main">
					<div class="rightpanel" id="rightpanel">
                        ...
                        <div class="dynamicdivs" id="dashboard">
                            <ul class="side-menu" id="adminlinks">
                                ...
                                <li>
                                    <a href="/Dexter/actions/admin/im.do" class="current">Instant Messaging</a>
                                </li>
                                <li>
					...
					<div class="leftpanel" id="leftpanel">
						<div class="rightcolumn">
							...
							<div class="dynamicdivs" id="removeimservice">
								<div class="centeradmin">

                                    <html:form action="/actions/admin/im">
                                        <span class="center">
                                            <h4 class="success">${IMFormBean.removeSuccess}</h4>
                                            <h4 class="error">${IMFormBean.removeError}</h4><br>
                                        </span>
                                            <div class="fleft">
                                                <h3 class="headinginline">Select IM:</h3>
                                            </div>
                                            <div class="fright">
                                                <html:select property="removeIM" styleClass="input">
                                                    <html:optionsCollection name="IMBean" value="serviceName" label="serviceName"/>
                                                </html:select>
						...
						<div class="leftcolumn">
							...
							<div class="dynamicdivs" id="addimservice">
                                <blockquote>
                                    <html:form action="/actions/admin/im">
                                        <span class="center">
                                            <h4 class="success">${IMFormBean.addSuccess}</h4>
                                            <h4 class="error">${IMFormBean.addError}</h4><br>
                                        </span>
                                        <b>Category Name:</b><br>
                                        <html:text styleClass="input" property="createIM"></html:text><br><br>
