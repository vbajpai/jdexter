					...
					<div class="rightpanel" id="rightpanel">
                        ...
                        <div class="dynamicdivs" id="dashboard">
                            <ul class="side-menu" id="adminlinks">
                                ...
                                <li>
                                    <a href="/Dexter/actions/admin/user.do" class="current">User</a>
                                </li>
                                <li>
                        ...
                        <div class="rightcolumn">
                            ...
                            <div class="dynamicdivs">
                                <div class="centeradmin">
                                    <html:form action="/actions/admin/user">
                                        <div class="fleft">
                                            <h3 class="headinginline">Select To Revoke Ban:</h3>
                                        </div>
                                        <div class="fright">
                                            <html:select property="banneduser" styleClass="input">
                                                <html:optionsCollection name="BannedUserBean" value="id" label="label"/>
                                            </html:select>
                                            <html:submit value="Revoke" styleClass="input"></html:submit>
                                        </div>
                                        <div class="clear"></div>
                                    </html:form>
                                </div>
                        ...
                        <div class="leftcolumn">
                            ...
                            <div class="dynamicdivs" id="addmoderator">
                                <div class="centeradmin">
                                    <html:form action="/actions/admin/user">
                                        <div class="fleft">
                                            <h3 class="headinginline">Select To Ban:</h3>
                                        </div>
                                        <div class="fright">
                                            <html:select property="user" styleClass="input">
                                             ...
                                             <html:submit value="Ban" styleClass="input"></html:submit>
                                        </div>
                                    </html:form>
                                </div>
                            </div>
