                            ...
                            <ul class="nobullet demarcate">
                                ...
                                <c:forEach var="resultbean" items="${searchdexter}">
                                    <li>
                                        ...
                                        <div class="fleft">
                                            <div>
                                                <a href="/Dexter/web/guest/ssl/signin.jsp?forwardsearch=${param.search}&forwardpage=${param.page}"><img src="/Dexter/_images/greyup.png" alt="UP" width="29" height="27"></a>
                                                <a href="/Dexter/web/guest/ssl/signin.jsp?forwardsearch=${param.search}&forwardpage=${param.page}"><img src="/Dexter/_images/greydown.png" alt="DOWN" width="29" height="27"></a>
