<%-- 
    Document   : index
    Created on : Mar 10, 2009, 9:49:38 PM
    Author     : rahul
--%>
                    ...
                    <div class="rightpanel" id="rightpanel">
                        ...
                        <div class="dynamicdivs" id="dashboard">
                            <ul class="side-menu" id="modlinks">
                                <li>
                                    <a href="/Dexter/web/mod/index.jsp" class="current">Moderator Home</a>
                                </li>
                                <li>
                            ...
                            <div class="timeframe sublinks" id="timeframe">
                                <div class="block">
                                    <c:choose>
                                        ...
                                        <c:otherwise>
                                            <a class="blueblock block header" href="">SubmissionDate</a>
                                        </c:otherwise>
                                    </c:choose>
                                    <c:choose>
                                        ...
                                        <c:otherwise>
                                            <a class="blueblock block header" href="">No.ofReports</a>
                                        </c:otherwise>
